...
const projects = [
  ...
  },
  {
    ...
    description: 'Introduction to full-stack web development by cloning Stack Overflow.',
  ...
  },
  {
    ...
    description: 'A collaborative data analytics project that assesses the state of global happiness.',
    techStack: ['Python', 'Pandas', 'NumPy', 'Matplotlib', 'Seaborn', 'Scikit-learn', 'Jupyter Notebook'],
    iconStack: ['python', 'pandas', 'numpy', 'matplotlib', 'seaborn', 'scikit', 'jupyter'],
  },
  {
